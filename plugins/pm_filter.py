...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('✨ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ:ʀᴇᴍᴏᴠᴇ ᴀᴅꜱ✨', callback_data='buyit') 
                  ]]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴜꜱᴇʀ ᴄᴏᴍᴍᴀɴᴅꜱ', callback_data='filters'),
            InlineKeyboardButton('ɢʀᴏᴜᴘ ᴄᴏᴍᴍᴀɴᴅꜱ', callback_data='store_file')
        ], [
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ᴛᴏ ʜᴏᴍᴇ ⇋', callback_data='start')
        ]]
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.USERCMDS,
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )

        elif query.data == "goupcmd":
        buttons = [[
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='help')
        ]]
        await client.edit_message_media(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('•ᴏᴡɴᴇʀ•', callback_data='https://t.me/EK4MPREETSINGH'),
